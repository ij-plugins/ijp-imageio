...
public class JAIFilePreviewer extends JPanel
  ...
  private IconCanvas iconCanvas1 = new IconCanvas();
...
//      t.printStackTrace();
  ...
  private void jbInit() throws Exception {
    ...
    iconCanvas1.setMinimumSize(new Dimension(iconSizeX, iconSizeY));
    iconCanvas1.setPreferredSize(new Dimension(iconSizeX, iconSizeY));
    this.add(iconCanvas1, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
