 ...
 * @author Jarek Sacha
 */
public class ImagePlusCreatorTest extends TestCase {

    public ImagePlusCreatorTest(final String test) {
        super(test);
    }
    ...
    public void testCreateProcessor1() throws Exception {
        ...
        final ImageProcessor dest = ImagePlusCreator.createProcessor(src);
        assertNotNull(dest);
