...
import ij_plugins.imageio.impl.*;
...
import static ij_plugins.imageio.IJImageOUtils.isBinary;
...
public final class ImageIOSaveAsPlugin implements PlugIn {
    ...
    private Optional<WriterOptions> askForWriterOptions(final ImagePlus imp, final ImageWriter writer) throws IJImageIOException {
        ...
        if (spiPluginClassName != null && spiPluginClassName.endsWith(".TIFFImageWriter")) {
            ...
            final Optional<ImageWriteParam> writerParamOpt = ImageIOWriter.askForCompressionParams(writer, TITLE, null);
