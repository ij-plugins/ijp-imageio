...
//        setupFilter(null);
     ...
     */
    public ImageFileFilter(final ImageWriterSpi spi, final String decription) {
...
//
    ...
    public String getCodecName() {
        return spi.getDescription(null);
    }
//
//
//    /*
...
//            throw new RuntimeException("MIN_IMAGE_FILE_SIZE set too low, need to be at least "
//                    + maxHeaderSize);
//        }
//
