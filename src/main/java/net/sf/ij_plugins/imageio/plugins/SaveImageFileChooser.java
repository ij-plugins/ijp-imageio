...
import net.sf.ij_plugins.imageio.IJIOUtils;
...
public class SaveImageFileChooser
    ...
    public SaveImageFileChooser(final File currentDirectory) {
        ...
        ImageFileFilter defaultFilter = null;
        final ArrayList<ImageFileFilter> filters = new ArrayList<>();
        for (ImageWriterSpi spi : spis) {
            try {
                ...
                final ImageFileFilter fileFilter = new ImageFileFilter(spi, extension.toUpperCase() + " - " + spiDescription);
    ...
    private void possiblyRecoverRecoveredFile(final ImageFileFilter imageFileFilter) {
