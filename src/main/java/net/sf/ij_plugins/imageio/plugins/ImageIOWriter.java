...
//     */
//    public ImageIOWriter(final ImageWriterSpi spi) {
//        this.spi = spi;
//    }
//
//
...
//    }
//
//    public void setSpi(final String formatName) {
...
//                }
//                if (list.size() > 0) {
//                    tiffEncodeParam.setExtraImages(list.iterator());
//                }
//
...
//                }
//
//                tiffEncodeParam.setExtraFields(extraTags.toArray(new TIFFField[extraTags.size()]));
//
//                imageEncoder.setParam(tiffEncodeParam);
