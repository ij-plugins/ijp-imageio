...
public class IJImageIOWriterPlugin implements PlugIn {
    ...
    private static void writeSingle(final ImagePlus imp,
                                    ...
                                    final String title) {
        final BufferedImage bi = BufferedImageCreator.create(imp, 0, useOneBitCompression);
...
//            write(imp, file, "PNG", null, useOneBitCompression);
            IJImageIO.write(bi, writer, file, parameters, null);
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < imp.getNSlices(); i++) {
                    final BufferedImage bi = BufferedImageCreator.create(imp, i, useOneBitCompression);
